...
In the previous line, the pipe operator passes `modnn` as the first argument to `setup()`. The `setup()` function emmbedes these specification into a new model object.
